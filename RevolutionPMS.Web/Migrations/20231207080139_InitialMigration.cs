        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxPersentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VATNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    ...
                    AccountablePerson = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillingTemplatesBoards", x => new { x.BillingTemplateId, x.BoardId });
                    table.ForeignKey(
                        name: "FK_BillingTemplatesBoards_BillingTemplates_BillingTemplateId",
                        column: x => x.BillingTemplateId,
                        principalTable: "BillingTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BillingTemplatesBoards_Boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsTaxIncludedInThePrices = table.Column<bool>(type: "bit", nullable: false),
                    TaxName = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    TaxPersentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PriceRounding = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxSettings_Currencies_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarketingEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseholdTaskId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Rooms_HouseholdTasks_HouseholdTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingTemplatesBoards_BoardId",
                table: "BillingTemplatesBoards",
                column: "BoardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxSettings_CurrencyId",
                table: "TaxSettings",
                column: "CurrencyId");
        }
